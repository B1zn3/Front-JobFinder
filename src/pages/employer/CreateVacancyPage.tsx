...
const STEPS: StepKey[] = ['main', 'description', 'conditions', 'skills', 'preview']
...
const createVacancy = async (payload: VacancyPayload): Promise<VacancyResponse> => {
...
const validateVacancyTitle = (value: string) => {
  ...
  if (title.length > 120) return 'Название вакансии должно быть не длиннее 120 символов.'
...
const SelectCombo = ({
  ...
  return (
    <div className={`vacancy-combo ${isOpen ? 'is-open' : ''}`}>
      ...
      >
        <span className={value ? 'vacancy-combo-field__value' : 'vacancy-combo-field__placeholder'}>
          {value || placeholder}
        </span>
...
export const CreateVacancyPage = () => {
  ...
  const validateMainStep = () => {
    ...
    if (!professionId || !professionName.trim()) return 'Выберите профессию из списка.'
  ...
  const validateConditionsStep = () => {
    ...
    if (!min) return 'Укажите зарплату от или отметьте “Не указывать зарплату”.'
    if (!max) return 'Укажите зарплату до или отметьте “Не указывать зарплату”.'
  ...
  const createVacancyRequest = async () => {
    ...
    try {
      ...
      await Promise.all(
        selectedSkills.map((skill) => addSkillToVacancy(createdVacancy.id, skill.name)),
      )
        ...
        <div className="container create-vacancy-page__container">
          <section className="create-vacancy-card">
            ...
            {currentStepKey === 'main' && (
              <>
                ...
                <p className="create-vacancy-card__subtitle">
                  Укажите название вакансии, профессию и город. Все три поля обязательны.
                </p>
                ...
                <div className="vacancy-form-grid vacancy-form-grid--two">
                  ...
                  <label className="vacancy-field">
                    ...
                    <SearchCombo
                      ...
                      activeValue={cityId}
                      emptyText={
                        citiesQuery.isLoading ? 'Загружаем города...' : 'Город не найден'
                      }
            ...
            {currentStepKey === 'description' && (
              <>
                <h1 className="create-vacancy-card__title">Описание вакансии</h1>
            ...
            {currentStepKey === 'conditions' && (
              <>
                ...
                <p className="create-vacancy-card__subtitle">
                  Заполните формат работы, график, опыт и зарплату. Если зарплату показывать не нужно,
                  отметьте чекбокс.
                </p>
                ...
                <div className="vacancy-form-grid vacancy-form-grid--two">
                  ...
                  <label className="vacancy-field">
                    ...
                    <SelectCombo
                      ...
                      emptyText={
                        currenciesQuery.isLoading ? 'Загружаем валюты...' : 'Нет вариантов'
                      }
                      onToggle={() =>
                        setOpenCombo((prev) =>
            ...
            {currentStepKey === 'skills' && (
              <>
                ...
                <p className="create-vacancy-card__subtitle">
                  Добавьте навыки, которые будут показаны в карточке вакансии. Минимум один навык обязателен.
                </p>
                ...
                <label className="vacancy-field">
                  ...
                  <SearchCombo
                    ...
                    emptyText={skillsQuery.isLoading ? 'Загружаем навыки...' : 'Навык не найден'}
              ...
              <>
                ...
                <section className="vacancy-preview-hero">
                  <div className="vacancy-preview-hero__content">
                    ...
                    <div className="vacancy-preview-hero__city">
                      {cityName}
                    </div>
                    ...
                    <button type="button" className="vacancy-preview-hero__apply" disabled>
                      Откликнуться
                    </button>
                  </div>

                  <div className="vacancy-preview-hero__salary">
                    {formatSalary(salaryMin, salaryMax, currencyName, salaryHidden)}
                  </div>
                </section>
            ...
            {saveError ? <div className="vacancy-form-error">{saveError}</div> : null}
            {saveSuccess ? <div className="vacancy-form-success">{saveSuccess}</div> : null}
          </section>
        </div>
      </main>
